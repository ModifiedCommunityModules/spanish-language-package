...
define('ENTRY_PICKUP_ADDRESS', 'Direcci&oacute;n de recogida:');
...
define('TEXT_SHIPCLOUD_DPAG_WARENPOST', 'Correo de mercanc&iacute;as');
define('TEXT_SHIPCLOUD_DPAG_WARENPOST_UNTRACKED', 'Warenpost (sin seguimiento)');
define('TEXT_SHIPCLOUD_DPAG_WARENPOST_SIGNATURE', 'Warenpost (firma)');
