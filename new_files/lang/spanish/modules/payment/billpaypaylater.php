...
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO1', 'Gracias por elegir pagar con PayLater. Las cantidades debidas se cargar&aacute;n en la cuenta especificada en el pedido. Adem&aacute;s de esta factura, Billpay le proporcionar&aacute; en breve un plan de pago con informaci&oacute;n detallada sobre sus cuotas.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO2', 'La orden fue emitida por ');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO3', '');

define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_FEE_INFO1', 'El pago posterior de esta orden es ');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_FEE_INFO2', '');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_PROMO', 'Haz clic en el bot&oacute;n de radio para mostrar m&aacute;s.');

// OT
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_FEE', 'Cuota de servicio');
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_TOTAL', 'Total + tasa de PayLater');

define('MODULE_PAYMENT_BILLPAY_GIROPAY_CANCELED', 'Giropay cancel&oacute;');
...
// Plugin 1.7
define('MODULE_PAYMENT_BILLPAYPAYLATER_THANK_YOU_TEXT', 'Gracias por elegir BillPay PayLater Instalment al hacer su compra.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_PAY_UNTIL_TEXT', 'Las cantidades adeudadas se cargar&aacute;n mensualmente en la siguiente cuenta:');
define('MODULE_PAYMENT_BILLPAYPAYLATER_EMAIL_TEXT', 'Adem&aacute;s de la factura, en breve recibir&aacute; un plan de cuotas con informaci&oacute;n detallada sobre sus pagos.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_TITLE', 'PayLater | Entrega');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_DESCRIPTION', 'PayLater | Entrega');
