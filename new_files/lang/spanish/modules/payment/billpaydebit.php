...
# only this payment
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_TITLE', 'BillPay - D&eacute;bito directo');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_DESCRIPTION', 'BillPay - D&eacute;bito directo');


define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO1', 'Gracias por elegir pagar por domiciliaci&oacute;n bancaria con BillPay. Cobraremos la cantidad adeudada en los pr&oacute;ximos d&iacute;as.');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO2', 'La orden fue emitida por ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO3', '');

define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO1', 'El cargo por domiciliaci&oacute;n bancaria para esta orden es ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO2', '');

// Plugin 1.7
define('MODULE_PAYMENT_BILLPAYDEBIT_THANK_YOU_TEXT', 'Gracias por elegir el d&eacute;bito directo de BillPay al hacer su compra.');
define('MODULE_PAYMENT_BILLPAYDEBIT_PAY_UNTIL_TEXT', 'En los pr&oacute;ximos d&iacute;as cargaremos %1$s %2$s en la siguiente cuenta:');
define('MODULE_PAYMENT_BILLPAYDEBIT_EMAIL_TEXT', 'BillPay le informar&aacute; por adelantado, por correo electr&oacute;nico, de la fecha en que se efectuar&aacute; el cargo en su cuenta.');
